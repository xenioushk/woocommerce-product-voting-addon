        ...
        <!-- Product Filter Type -->   
         ...
         <p>
                ...
                <select id="<?php echo $this->get_field_id('bwl_pvm_filter_type'); ?>" name="<?php echo $this->get_field_name('bwl_pvm_filter_type'); ?>" class="widefat" style="width:100%;">
                    <option value="1_day" <?php if ( $instance['bwl_pvm_filter_type'] == '1_day' ) echo 'selected="selected"'; ?>><?php _e('Last 1 Day', 'bpvm_wpva'); ?></option>                        
                    <option value="1_week" <?php if ( $instance['bwl_pvm_filter_type'] == '1_week' ) echo 'selected="selected"'; ?>><?php _e('Last 1 Week', 'bpvm_wpva'); ?> ( Default )</option>                        
                    <option value="1_month" <?php if ( $instance['bwl_pvm_filter_type'] == '1_month' ) echo 'selected="selected"'; ?>><?php _e('Last 1 Month', 'bpvm_wpva'); ?></option>                        
                    <option value="6_month" <?php if ( $instance['bwl_pvm_filter_type'] == '6_month' ) echo 'selected="selected"'; ?>><?php _e('Last 6 Month', 'bpvm_wpva'); ?></option>
                    <option value="count_all" <?php if ( $instance['bwl_pvm_filter_type'] == 'count_all' ) echo 'selected="selected"'; ?>><?php _e('Count All', 'bpvm_wpva'); ?></option>
                </select>
        </p>
        
        <!-- Display Front End Filter  -->
        <p>            
            <label for="<?php echo $this->get_field_id('bwl_pvm_display_front_filter'); ?>"><?php _e('Display Frontend Voting Filter' , 'bpvm_wpva'); ?>: </label>
            <input id="<?php echo $this->get_field_id('bwl_pvm_display_front_filter'); ?>" 
                       name="<?php echo $this->get_field_name('bwl_pvm_display_front_filter'); ?>" 
                       type="checkbox" <?php checked($bwl_pvm_display_front_filter, 'on'); ?> />
        </p>
        ...
        <!-- Order Type -->   
         ...
         <p>
                ...
                <select id="<?php echo $this->get_field_id('bwl_pvm_order_type'); ?>" name="<?php echo $this->get_field_name('bwl_pvm_order_type'); ?>" class="widefat" style="width:100%;">
                    <option value="liked" <?php if ( $instance['bwl_pvm_order_type'] == 'liked' ) echo 'selected="selected"'; ?>><?php _e('Liked', 'bpvm_wpva'); ?></option>                        
                    <option value="disliked" <?php if ( $instance['bwl_pvm_order_type'] == 'disliked' ) echo 'selected="selected"'; ?>><?php _e('Disliked', 'bpvm_wpva'); ?></option>                        
                </select>
        </p>
            ...
            foreach ( $query_results as $bpvm_filter_post_info ) {
                ...
                if( $thumb == 1 ) {
                    ...
                    if ( empty($post_thumb) ) {
                        ...
                        $post_thumb = '<img src="http://localhost/dev.plugin/bpvm/wp-content/plugins/woocommerce/assets/images/placeholder.png" alt="" />';
                        
                    }
                    
//                    $post_thumb = woocommerce_get_product_thumbnail();
